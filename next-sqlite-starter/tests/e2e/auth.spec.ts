...
test.describe('Authentication Flows', () => {
  ...
  test('should display sign-up page and render Clerk form', async ({ page }) => {
    ...
    await page.waitForSelector('[role="main"], .cl-rootBox, form', { timeout: 5000 });
  ...
  test('should display sign-in page and render Clerk form', async ({ page }) => {
  ...
  test('should have SignOut button on dashboard (when authenticated)', async ({ page }) => {
